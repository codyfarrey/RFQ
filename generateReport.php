    ...
    <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <a class="nav-link" href="./generateReport.php">Generate Report<span class="sr-only">(current)</span></a>
        </li>
          </ul>
          ...
          <div class="box">
            ...
            <div class="row">
              <div class="col">
                ...
                <br />
                <input type="checkbox" class="form-check" onclick="deselectSelectAll()" name="content[]" <?php if (isset($report) && $report =="RFQ.RFQID" || isset($report) && $report =="all") echo "checked";?> value="RFQ.RFQID" id="RFQ.RFQID" autocomplete="off"> 
                <label for="rfqId" class="form-check-label">Request For Quote</label>
                <br />
                <input type="checkbox" class="form-check" onclick="deselectSelectAll()" name="content[]" <?php if (isset($report) && $report =="CustomerAccount.CompanyName") echo "checked";?> value="CustomerAccount.CompanyName" id="CustomerAccount.CompanyName" autocomplete="off"> 
                <label for="CustomerAccount.CompanyName" class="form-check-label">Customer Account</label>
              </div>
              <div class="col">
                <input type="checkbox" class="form-check" onclick="deselectSelectAll()" name="content[]" <?php if (isset($report) && $report =="Inventory.Name") echo "checked";?> value="Inventory.Name" id="Inventory.Name" autocomplete="off"> 
                <label for="Inventory.Name" class="form-check-label">Part</label>
                <br />
                <input type="checkbox" class="form-check" onclick="deselectSelectAll()" name="content[]" <?php if (isset($report) && $report =="RFQDetail.Quantity") echo "checked";?> value="RFQDetail.Quantity" id="RFQDetail.Quantity" autocomplete="off"> 
                <label for="RFQDetail.Quantity" class="form-check-label">Part Quantity</label>
                <br />
                <input type="checkbox" class="form-check" onclick="deselectSelectAll()" name="content[]" <?php if (isset($report) && $report =="Inventory.Price") echo "checked";?> value="Inventory.Price" id="Inventory.Price" autocomplete="off"> 
                <label for="Inventory.Price" class="form-check-label">Part Price</label>
              </div>
            </div>
